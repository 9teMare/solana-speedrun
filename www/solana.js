...
const HTTP_RPC_URL = "https://solana-devnet.g.alchemy.com/v2/huCDT74XQJEq2Ed1AF8e1lDisWJulLHV";
const WS_RPC_URL = "wss://solana-devnet.g.alchemy.com/v2/huCDT74XQJEq2Ed1AF8e1lDisWJulLHV";
                ...
                for (const [_pubkey, queryResult] of accountStore) {
                    if (queryResult.wsSubscriptionId === params.subscription) {
                        if ("error" in params) {
                            ...
                            queryResult.error = params.error.message ?? "Error in WebSocket notification";
